...
server=$(find ./dsrc/sku.0/sys.server/compiled/game/datatables/buildout -name '*.tab')
inc=$(find ./dsrc/sku.0/sys.shared/compiled/game/datatables/include -name '*.tab')
shared=$(find ./dsrc/sku.0/sys.shared/compiled/game/datatables/buildout -name '*.tab')
